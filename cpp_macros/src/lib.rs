    ...
    let call = if is_void {
        ...
        quote! {
            if false {
                ...
                const _assert_size: [(); #ret_size] = [(); ::std::mem::size_of::<#ret_ty>()];
                const _assert_align: [(); #ret_align] = [(); ::std::mem::align_of::<#ret_ty>()];
            }
            let mut result = ::std::mem::MaybeUninit::<#ret_ty>::uninit();
                ...
                impl ::std::clone::Clone for #class_name {
                    fn clone(&self) -> Self {
                        unsafe {
                            ...
                            #copyctr_name(& *self, ret.as_mut_ptr());
                            ret.assume_init()
                        }
                    }
                }
            ...
            impl ::std::default::Default for #class_name {
                fn default() -> Self {
                    unsafe {
                        ...
                        let mut ret = ::std::mem::MaybeUninit::<Self>::uninit();
                        #defaultctr_name(ret.as_mut_ptr());
                        ret.assume_init()
                    }
                }
            }
